...
// describe("multiply", ()=>{
//   it("should return the a new arithmrtic value as the original number multiplied by the new",()=>{
//     const num=10;
//     const multiplied=100;
//     const result=num * multiplied;

//     const {number} = new Arithmetic(num).multiply(multiplied);
...
// describe("divide", ()=>{
//   it("should return a new arithmetic value as the original number divided by the new",()=>{
//   const num = 10;
//   const divided = 5;
//   const result= num / divided;
//   const {number} = new Arithmetic(num).divide(divided);
